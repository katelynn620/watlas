...
$image[1]=GetTagImgKao(l("王様"),"king",'align="left" ');
# require $JCODE_FILE;
DataRead();
...
${\l('そなたの出店にあたり，王国が結ぶ契約は以下の通りである。')}<br>
<ul><li>
${\l('汝，<SPAN>造船</SPAN>を志すならば，他国には作れぬ船と大砲を作るべし。')}
</li>
<li>
${\l('汝，<SPAN>冒険</SPAN>を志すならば，世界の発見を王国に報告せよ。<br> 発見した事実は他言無用とすべし。')}
</li>
<li>
${\l('汝，<SPAN>交易</SPAN>を志すならば，世界の商品をすべて王国に集めるべし。')}
</li>
<li>
${\l('汝，<SPAN>海賊</SPAN>を志すならば，他国の商船を攻撃せよ。<br> ただし，王国の名を名乗ってはならぬ。')}
</li>
<li>
